        ...
        <div class="col-md-12">
            <div class="profile-header">
                <div class="row align-items-center">
                    ...
                    <div class="col ml-md-n2 profile-user-info">
                        ...
                        <h6 class="text-muted"> <i class="fa fa-mail"></i>{{Auth::guard('admin')->user()->email}}</h6>
                        <div class="user-Location"><i class="fa fa-user"></i> {{Auth::guard('admin')->user()->role->name}}</div>
            ...
            <div class="profile-menu">
                <ul class="nav nav-tabs nav-tabs-solid">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#photo_tab">Upload Photo</a>
                    </li>
                </ul>
            </div>
